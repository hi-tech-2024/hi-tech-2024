...
18. На COD-CLI настройте SSO для обращения к `https://portal.hitech.ru` под пользователем **hitech24\AdriaLogan** и **hitech24\AidanByrd** (Доступ без ввода пароля, без ошибок и предупреждений у одного и запрет доступа у другого). **Важно! Провека будет осуществляться в Mozilla Firefox.**
