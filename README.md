...
5. На SRV-A реализуйте почтовый сервер.
    ...
    2. Обеспечьте аутентификацию с использованием доменных учетных данных.
        - Доступ к почте должны получать пользователи office.hitech24.local
    ...
    4. При входе пользователь должен указывать только логин учетной записи и почтовый домен в формате `username@office.hitech24.local` для домена office и `username@branch.hitech24.local` для домена branch.
...
5. На DC-B реализуйте почтовый сервер.
    1. Соединение с почтовым сервером должно быть защищено. Клиент не должен получать ошибок в почтовом клиенте.
    2. Обеспечьте аутентификацию с использованием доменных учетных данных.
        - Доступ к почте должны получать пользователи branch.hitech24.local
...
9. На виртуальной машине WEB2 разверните корпоративный репозиторий.
    ...
    2. Подключите корпоративный репозиторий по записи `deb https://repo.hitech2024.local hitech24 hitech24-apps` на всех виртуальных серверах в ЦОДе и на CLI-*.
