...
5. На ISP преднастроена запись vpn.hitech24.ru с адресом 203.0.113.100.
6. Параметры интернет-провайдеров, предоставляющих услуги организации или клиентам.
...
7. Провайдеронезависимые (PI) адреса и ASN в ЦОДе
...
9. В сетях MOONET и GIGAFON COD сделаны настройки BGP.
...
10. На DNS-сервере (все адреса ISP) настроена зона hitech24.ru
11. На виртуальных машинах будут использоваться следующие версии ОС:
